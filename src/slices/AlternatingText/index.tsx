        ...
        <div className="relative z-[100] grid">
          ...
          {slice.primary.text_group.map((item, index) => (
            <div
              ...
              className="alternating-section grid min-h-screen py-24 place-items-center gap-x-12 md:h-screen md:py-0 md:grid-cols-2"
            >
              <div
                className={clsx(
                  index % 2 === 0 ? "col-start-1" : "md:col-start-2",

                  "rounded-lg p-4 max-md:p-8 backdrop-blur-lg max-md:bg-white/50",
                )}
              >
